      ...
      <Popover className="relative">
        {({ open }) => (
          <>
            ...
            >
              <Popover.Panel className="absolute z-10 w-72 max-w-sm px-4 mt-3 transform -translate-x-1/2 -left-14 sm:px-0 lg:max-w-3xl border-0">
                  ...
                  <div className="p-4 bg-gray-50">
                    ...
                    >
                      <div className="flex items-center text-sm font-medium text-red-500">
                        <LogoutIcon className="w-8 h-8 text-gray-700" />
